<div class="d-influencer">
    <div class="hero-influencer">
        <div class="text-section">
            ...
            <div>
                <a href="https://meu.clubeparcerias.com.br/" target="_blank"> <button class="btn btn-add">ACESSE
                        AQUI</button></a>
            </div>
    ...
    <div class="hero-5">
        ...
        <div class="section-text">
            <div>
                <p><span>Cartão com você</span> é um novo cartão de descontos do Brasil. Ele oferece descontos de até
                    75%
                    principalmente
                    nas áreas de saúde, educação e lazer. Pagando um valor mensal, você pode aproveitar todos os
                    benefícios
    ...
    <div class="section-2 pe-5">
        <div>
            <img src="{{ asset('front/img/carlinhos-maia.png') }}" alt="">
        </div>
        <div>
            <div>
    ...
    <div class="section-3 container">
        ...
        <div>
            <img src="{{ asset('front/img/car-car.png') }}" alt="">
        </div>
    </div>
</div>
